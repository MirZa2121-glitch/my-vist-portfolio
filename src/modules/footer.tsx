            ...
            <div className="w-full lg:max-w-7xl mx-auto px-4 py-12 md:py-16">
                <div className="grid gap-10 lg:grid-cols-4">
                    <div className="space-y-5">
                        ...
                        <p className="text-sm text-[#B7C0E2]">Junior Front-end разработчик. Создаю быстрые и удобные веб-приложения.</p>
                        <div className="flex items-center gap-3">
                            <a href="https://github.com/MirZa2121-glitch" className="footer-icon flex h-11 w-11 items-center justify-center rounded-full border border-[#445076] bg-[#141B34] hover:bg-[#6D5EF9] transition">
                                <img src={$ICONS.github} alt="GitHub" className="h-5 w-5" />
                            </a>
                            ...
                            <a href="mailto:mirza.dev@gmail.com" className="footer-icon flex h-11 w-11 items-center justify-center rounded-full border border-[#445076] bg-[#141B34] hover:bg-[#6D5EF9] transition">
                                <img src={$ICONS.mail} alt="Email" className="h-5 w-5" />
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="space-y-5">
                        ...
                        <ul className="space-y-3 text-sm text-[#B7C0E2]">
                            <li><a href="#about" className="hover:text-white transition">Обо мне</a></li>
                            <li><a href="#portfolio" className="hover:text-white transition">Проекты</a></li>
                            <li><a href="#work" className="hover:text-white transition">UX/UI дизайн</a></li>
                            <li><a href="#stack" className="hover:text-white transition">Стек</a></li>
                            <li><a href="#another" className="hover:text-white transition">Другие работы</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="space-y-3 text-sm text-[#B7C0E2]">
                            <div>
                                ...
                                <a href="#" className="block hover:text-white transition">@mirza_amir_r</a>
                            </div>
                        </div>
                    </div>

                    <div className="space-y-5 rounded-[24px] bg-[#111827] p-6">
                        <h3 className="text-lg font-semibold text-white">Давайте работать вместе!</h3>
                        <p className="text-sm text-[#B7C0E2]">Открыт для интересных проектов и новых возможностей.</p>
                        <a href="#contact" className="inline-flex items-center justify-center gap-2 rounded-[12px] bg-gradient-to-r from-[#6D5EF9] to-[#7B62FF] px-5 py-3 text-sm font-semibold text-white transition hover:brightness-110">
                            Связаться со мной
                            <img src={$ICONS.arrowForward} alt="Arrow" className="h-4 w-4" />
                        </a>
                    </div>
                </div>
                ...
                <div className="mt-10 border-t border-[#2E3A57] pt-6 text-sm text-[#93A3BF] flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <p>© 2024 Mirza.dev. Все права защищены.</p>
                    <a href="#intro" className="inline-flex h-11 w-11 items-center justify-center rounded-full bg-[#1F2A4B] text-white transition hover:bg-[#6D5EF9]">
                        <img src={$ICONS.arrowDown} alt="Up" className="h-5 w-5 rotate-180" />
                    </a>
                </div>
            </div>
        </footer>
